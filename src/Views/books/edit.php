    ...
    <div class="card bg-white rounded shadow relative border-l-4 border-purple-900">
        <form action="/livres/<?php echo $book["slug"]; ?>" method="post">
            <header class="p-4 flex items-center">
                ...
                <div class="flex-grow">
                    <input id="title" type="text" name="title" value="<?php echo escape($book["title"]); ?>" class="w-10/12 rounded border py-2 px-4">
            ...
            <div class="p-4 flex items-center border-t">
                ...
                <div class="flex-grow">
                    <input id="title" type="text" name="author" value="<?php echo escape($book["author"]); ?>" class="rounded border py-2 px-4 w-full" placeholder="Votre auteur">
            ...
            <div class="content border-t border-b p-4 flex-grow flex items-center">
                ...
                <div class="flex-grow">
                    <textarea name="description" id="description" rows="10" class="w-full rounded border py-2 px-4"><?php echo escape($book["description"]); ?></textarea>
            ...
            <footer class="p-4 flex justify-between items-center">
                <div class="flex">
                    ...
                    <div class="flew-grow">
                        <input type="date" class="rounded border py-2 px-4" name="date" id="date" value="<?php echo escape($book["date"]); ?>">
        ...
        <form action="/livres/<?php echo $book["date"]; ?>/delete" method="post" class="absolute top-0 right-0 mt-4 mr-4 text-white">
