...
<h1 class="mb-8 text-2xl font-bold"><i class="fas fa-book mr-4 text-purple-900"></i>Editer un Livre</h1>
    <div class="card bg-white rounded shadow relative border-l-4 border-purple-900">
        <form action="/livre/<?php echo escape($book['slug']); ?>" method="post">
            ...
            <div class="p-4 flex items-center border-t">
                ...
                <div class="flex-grow">
                    <input id="author" type="text" name="author" value="<?php echo escape($book['author']); ?>" class="rounded border py-2 px-4 w-full" ">
            ...
            <footer class="p-4 flex justify-between items-center">
                <div class="flex">
                    ...
                    <div class="flew-grow">
                        <input type="date" class="rounded border py-2 px-4" name="date" id="date" value="<?php echo escape($book['created_at']); ?>">
                        <span class="text-red-500 font-bold"><?php echo error('created_at'); ?></span>
                    </div>
                </div>
