...
<div class="w-full md:w-3/4 lg:w-2/3 xl:w-1/2 mx-auto p-4">
    <div class="card bg-white rounded shadow border-l-4 border-purple-900">
        <header class="p-4 font-bold tracking-widest">
            <h3><i class="fas fa-heading mr-4 text-purple-900"></i><?php echo $book["title"]; ?></h3>
        </header>
        ...
        <footer class="p-4 flex justify-between items-center">
            ...
            <div class="actions flex">
                <a href="/livres/<?php echo $book["slug"]; ?>/edit" class="w-10 h-10 bg-yellow-500 hover:bg-yellow-600 text-white flex justify-center items-center rounded">
                    <i class="fas fa-edit"></i>
                </a>
                <form action="/livres/<?php echo $book["slug"]; ?>/delete" method="post">
                    <button type="submit" class="ml-4 bg-red-500 w-10 h-10 text-white flex justify-center items-center rounded "><i class="fas fa-trash-alt"></i></button>
                </form>
            </div>
        </footer>
    </div>
