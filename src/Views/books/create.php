        ...
        <form action="/livres/nouveau" method="post">
            <header class="p-4 flex items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['errors']['title']?></span>
                </div>
            </header>
            <div class="p-4 flex items-center border-t">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['errors']['author']?></span>
                </div>
            </div>
            <div class="content border-t border-b p-4 flex-grow flex items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['errors']['description']?></span>
                </div>
            </div>
            <div class="p-4 flex border-b items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['errors']['slug']?></span>
                </div>
            </div>
            <footer class="p-4 flex justify-between items-center">
                <div class="flex">
                    ...
                    <div class="">
                        ...
                        <span class="text-red-500 font-bold"><?php echo $_SESSION['errors']['date']?></span>
                    </div>
                </div>
