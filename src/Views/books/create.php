        ...
        <form action="/livres/nouveau" method="post">
            <header class="p-4 flex items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['title']?></span>
                </div>
            </header>
            <div class="p-4 flex items-center border-t">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['author']?></span>
                </div>
            </div>
            <div class="content border-t border-b p-4 flex-grow flex items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['description']?></span>
                </div>
            </div>
            <div class="p-4 flex border-b items-center">
                ...
                <div class="flex-grow">
                    ...
                    <span class="text-red-500 font-bold"><?php echo $_SESSION['slug']?></span>
                </div>
            </div>
            <footer class="p-4 flex justify-between items-center">
                <div class="flex">
                    ...
                    <div class="">
                        ...
                        <span class="text-red-500 font-bold"><?php echo $_SESSION['date']?></span>
                    </div>
                </div>
