...
ob_start();
?>
<h1 class="mb-8 text-2xl font-bold"><i class="fas fa-book mr-4 text-purple-900"></i>Tout Les Livres <a href="/books/nouveau" class="py-2 px-4 bg-green-500 hover:bg-green-600 float-right text-white text-base rounded">Créer</a></h1>
        ...
        <div class="w-full md:w-1/2 lg:w-1/3 xl:w-1/4 p-4">
            <div class="card bg-white rounded shadow h-full flex flex-col">
                ...
                <div class="content border-t border-b p-4 flex-grow flex items-center">
                    ...
                    <?php echo substr(escape($book['description']), 0, 80) . '...';?>
                </div>
